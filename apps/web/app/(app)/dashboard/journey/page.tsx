export default function JourneyPage() {
  return (
    <div className="px-4 py-12 max-w-lg mx-auto text-center mb-24">
      ...
      <h2 className="text-xl font-semibold text-[#1B4332] mb-2">My Journey</h2>
      <p className="text-sm text-gray-500">Your leadership development path — 360 profile, OBP tracking, and progress over time.</p>
