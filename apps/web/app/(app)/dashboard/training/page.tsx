    ...
    <div className="p-4 lg:p-6 max-w-3xl mx-auto">
      <div className="flex items-center justify-between mb-5">
        <div className="flex items-center gap-2">
          ...
          <div><p className="text-[28px] font-bold text-foreground tracking-tight leading-tight">Training Compliance</p><p className="text-[10px] text-muted-foreground">Mt Gib Gardens Bowral · All mandatory training</p></div>
        </div>
