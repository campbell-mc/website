...
const config: RoleHomeConfig = {
  ...
  subtitle: "Harbison · Workforce Safety & PSH",
  todaysPicture: "The overall PSH picture is improving this cycle — 2 teams elevated, down from 4 last cycle. However, Cottage Team still has a critical convergence: PSH_01 and PSH_08 have both been above threshold for 3 cycles. CHRIS has flagged a WC risk — this pattern has a 68% correlation with claims within 4-6 weeks, estimated exposure $288K. A DON-level intervention is recommended. ISO 45003 evidence is current across all 4 categories — the evidence pack is exportable if needed.",
  domains: [
    { name: "Elevated Teams", status: "watch", summary: "2 teams · down from 4 · improving trend", href: "/dashboard/whs/hazard-map" },
    { name: "Convergence", status: "act", summary: "1 critical · Cottage Team · 3 cycles", href: "/dashboard/whs/convergence" },
  ...
  topActions: [
    { priority: "act", label: "Cottage Team critical convergence — DON escalation recommended", actionLabel: "Escalate →", href: "/dashboard/psh" },
