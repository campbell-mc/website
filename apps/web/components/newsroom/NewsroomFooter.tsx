    ...
    <footer className="bg-[#1B4332]">
      <div className="max-w-6xl mx-auto px-6 lg:px-16 py-14">
        <div className="max-w-2xl">
          <div className="text-[11px] font-medium tracking-[0.08em] uppercase text-white/28 mb-5">
          ...
          <h2 className="text-[clamp(22px,3vw,36px)] font-normal text-white leading-[1.12] tracking-[-0.02em] mb-5" style={{ fontFamily: "var(--font-instrument-serif, 'Georgia'), serif" }}>
            ...
            <br />
            <em className="italic text-[#2D7D73]/70">The full platform does the rest.</em>
          </h2>
          <p className="text-[14px] text-white/42 leading-relaxed mb-8 max-w-md">
          ...
          <div className="flex items-center gap-4 flex-wrap">
            ...
            <Link href="/" className="border border-white/20 text-white/58 px-6 py-3 rounded-lg text-[13px] hover:border-white/38 hover:text-white/78 transition-colors">
              Back to CHRIS-OS
            </Link>
          </div>
