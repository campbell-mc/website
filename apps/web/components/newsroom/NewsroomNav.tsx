    ...
    <nav className="border-b border-[#1B4332]/10 bg-[#F5F2EB]">
      <div className="max-w-6xl mx-auto flex items-center justify-between px-6 lg:px-16 py-5">
        <Link href="/" className="flex items-center gap-2.5 group">
          <div className="w-8 h-8 bg-[#1B4332] rounded-lg flex items-center justify-center text-white text-sm font-medium tracking-tight group-hover:bg-[#1B4332]/90 transition-colors">
            C
          </div>
