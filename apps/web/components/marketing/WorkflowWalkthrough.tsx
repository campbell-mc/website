...
const WORKFLOWS: Record<string, WorkflowData> = {
  ...
  "07": {
    ...
    steps: [
      { title: "Fortnightly pulse deployed to all teams", agent: "The Keeper · Pulse cycle", description: "Every two weeks, CHRIS deploys a brief pulse survey to all teams. 16 psychosocial hazard domains measured. Participation tracked. Results available within 24 hours of cycle close.", chrisDid: "Deployed pulse, tracked participation, collected and scored responses across 16 PSH domains.", youDo: "Nothing — the pulse runs automatically.", screenshotBg: "#D4A017", screenshotLabel: "PSH pulse — cycle 9 complete" },
      { title: "Convergence detected — real hazard confirmed", agent: "The Keeper · Convergence detection", description: "The Keeper correlates pulse signals with rostering data, incident reports, and HR records. PSH_01 and PSH_08 are co-elevated in Grevillea Wing for the 6th consecutive cycle. This is a confirmed convergence, not noise.", chrisDid: "Cross-referenced pulse data with operational signals, confirmed convergence pattern, calculated risk probability.", youDo: "Review the convergence finding.", screenshotBg: "#C4704A", screenshotLabel: "PSH convergence — Grevillea Wing CRITICAL" },
        ...
        <div className="p-6 lg:p-10">
          ...
          {currentStep && !isFinalStep ? (
            <div className="grid grid-cols-1 lg:grid-cols-[55%_45%] gap-8">
              ...
              <div className="rounded-xl overflow-hidden" style={{ backgroundColor: currentStep.screenshotBg }}>
                <div className="aspect-[4/3] flex flex-col justify-between p-6">
                  ...
                  <div className="space-y-2 mt-auto">
                    <div className="bg-white/10 rounded-lg p-3">
                      <div className="h-1.5 bg-white/20 rounded w-3/4 mb-2" />
