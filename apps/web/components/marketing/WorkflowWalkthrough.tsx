...
const WORKFLOWS: Record<string, WorkflowData> = {
  ...
  "04": {
    ...
    steps: [
      ...
      { title: "Evidence register populated automatically", agent: "The Chronicler · Evidence chain", description: "When the action is marked complete, CHRIS populates the evidence register with the completion date, responsible person, and linked documentation.", chrisDid: "Logged completion, populated evidence register, linked to original finding.", youDo: "Confirm completion.", screenshotBg: "#2D7D73", screenshotLabel: "Evidence register — complete", screenshot: "/screenshots/quality-indicators.png" },
    ],
  },
  "05": {
    jobNumber: "05", jobTitle: "Give every leader their Monday briefing",
    steps: [
      { title: "Sunday 9pm — CHRIS starts building your briefing", agent: "Sentinel + Oracle + Keeper · Synthesis", description: "While you are offline, CHRIS runs the weekly synthesis cycle. The Sentinel checks care minutes and clinical compliance. The Oracle reviews the financial position. The Keeper assesses workforce signals. The Town Crier merges findings.", chrisDid: "Ran cross-agent synthesis cycle, identified converged signals, ranked this week's priorities, drafted narrative briefing.", youDo: "Nothing. You are offline.", screenshotBg: "#1B4332", screenshotLabel: "Agent synthesis — Sunday night", screenshot: "/screenshots/financial.png" },
